...
p1 = p + geom_line(aes(y=gdp)) + ggtitle("GDP in Billions ($)") + scale_y_continuous(labels=dollar)
p2 = p + geom_line(aes(y=population)) + ggtitle("US Population") + scale_y_continuous(labels=comma)
p3 = p + geom_line(aes(y=gdp.per.capita)) + ggtitle("GDP Per Capita") + scale_y_continuous(labels=dollar)
